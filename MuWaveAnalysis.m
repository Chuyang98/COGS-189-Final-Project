function MuWaveAnalysis()
    ...
    %% calculate the power
    [Power_Left_For_Img,Filtered_Left_For_Img] = powercalculation (19, 500, [8,13], LeftForwardImagined);
    [Power_Left_Back_Img,Filtered_Left_Back_Img] = powercalculation (19, 500, [8,13], LeftBackwardImagined);
    [Power_Right_For_Img,Filtered_Right_For_Img] = powercalculation (19, 500, [8,13], RightForwardImagined);
    [Power_Right_Back_Img,Filtered_Right_Back_Img] = powercalculation (19, 500, [8,13], RightBackwardImagined);
    %% Product Plots
    figure(1)
    subplot(2,2,1)
    fig15 = topoplot(Power_Left_For_Img, selected_loc);
    title("Imagined Left Hand Moving Forward")
    subplot(2,2,2)
    fig16 = topoplot(Power_Right_For_Img, selected_loc);
    title("Imagined Right Hand Moving Forward")
    subplot(2,2,3)
    fig17 = topoplot(Power_Left_Back_Img, selected_loc);
    title("Imagined Left Hand Moving Backward")
    subplot(2,2,4)
    fig18 = topoplot(Power_Right_Back_Img, selected_loc);
    ...
    figure(3)
    confusion1 = plotconfusion(right_left_for_img_LDA_test',right_left_for_img_LDA_approx', "LDA - Forward Movement");
    figure(4)
    confusion2 = plotconfusion(right_left_back_img_LDA_test',right_left_back_img_LDA_approx',"LDA - Backward Movement");
    %% Confusion Matrix - Conventional SVM
    figure(5)
    confusion3 = plotconfusion(right_left_for_img_SVM_test',right_left_for_img_SVM_approx', "SVM - Forward Movement");
    figure(6)
    confusion4 = plotconfusion(right_left_back_img_SVM_test',right_left_back_img_SVM_approx',"SVM - Backward Movement");
    
    %% Confusion Matrix - New LDA
    figure(7)
    confusion5 = plotconfusion(new_right_left_for_img_LDA_test',new_right_left_for_img_LDA_approx', "LDA - Forward Movement - New");
    figure(8)
    confusion6 = plotconfusion(new_right_left_back_img_LDA_test',new_right_left_back_img_LDA_approx',"LDA - Backward Movement - New")
     %% Confusion Matrix - New SVM
    figure(9)
    confusion7 = plotconfusion(new_right_left_for_img_SVM_test',new_right_left_for_img_SVM_approx', "SVM - Forward Movement - New")
    figure(10)
    confusion8 = plotconfusion(new_right_left_back_img_SVM_test',new_right_left_back_img_SVM_approx',"SVM - Backward Movement - New")
